...
const AwsNewCluster = React.lazy(() => import('./views/Provisioning/NewCluster/AWS/AwsNewCluster'));
const AzureNewCluster = React.lazy(() => import('./views/Provisioning/NewCluster/Azure/AzureNewCluster'));
const GCPNewCluster = React.lazy(() => import('./views/Provisioning/NewCluster/GCP/GCPNewCluster'));
...
const routes = [
  ...
  {path: '/provisioning/aws', name: 'NewCluster AWS', element: AwsNewCluster},
  {path: '/provisioning/azure', name: 'NewCluster Azure', element: AzureNewCluster},
  {path: '/provisioning/gcp', name: 'NewCluster GCP', element: GCPNewCluster},
]
