...
function AzureBeBuConfig(props) {
  ...
  const validate = (data) => {
    ...
    if (found === false) {
      ...
      let userMsiObjectIds = getArray(data.userMsiObjectIds)
      let groupMsiObjectIds = getArray(data.groupMsiObjectIds)

      let x = {
        be: data.be,
        bu: data.bu,
        namespace: ns,
        userMsiObjectIds: userMsiObjectIds,
        groupMsiObjectIds: groupMsiObjectIds,
      }
      ...
      <CModal size="lg" show={props.modalConfig} onClose={toggle} scrollable={true}>
        <CModalBody>
          ...
          <CCardBody>
            ...
            <CCardGroup row>
              <CCol md="3">
                <CFormLabel htmlFor="text-input">userMsiObjectIds</CFormLabel>
              </CCol>
              <CCol xs="12" md="9">
                <TagsInput tags={[]} register={register} errors={errors} name={"userMsiObjectIds"} keyValue={false}
                           required={true} placeholder={"enter as userMsiObjectIds"}/>
              </CCol>
            </CCardGroup>
            <CCardGroup row>
              <CCol md="3">
                <CFormLabel htmlFor="text-input">groupMsiObjectIds</CFormLabel>
              </CCol>
              <CCol xs="12" md="9">
                <TagsInput tags={[]} register={register} errors={errors} name={"groupMsiObjectIds"} keyValue={false}
                           required={true} placeholder={"enter as groupMsiObjectIds"}/>
              </CCol>
            </CCardGroup>
          </CCardBody>
          {/*</form>*/}
...
export default AzureBeBuConfig
